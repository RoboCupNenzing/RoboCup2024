...
void loop() {
  ...
  delay(2000);  //noch aendern
  MOVE_forward_steps(200, 650);
  Magnet_aus();
  delay(1500);


  MOVE_left_steps(200, 135);
  MOVE_forward_steps(200, 700);
  MOVE_left_steps(200, 60);

  Kanonnenfeuern();
  ZigbeeAbfragen("3");
  delay(500);
  MOVE_right_steps(200, 50);
  ...
  MOVE_right_steps(200, 130);
  MOVE_forward_steps(200, 400);
