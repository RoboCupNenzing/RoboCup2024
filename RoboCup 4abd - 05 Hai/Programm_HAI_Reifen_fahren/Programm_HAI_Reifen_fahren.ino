...
//Serielle Kommunikation
  #define rxPin 12   //grünes Kabel
  #define txPin 14   //gelbes Kabel
...
//Motorsteuerung:
#define PWMA 0   //(weiß) Pin für die Geschwindigkeit (Wert: 0 - 255)
#define AIN1 16  //(gruen) Pin1 für die Richtung (Vorwärts: HIGH, Rückwärts: LOW)
#define AIN2 4   //(gelb) Pin2 für die Richtung (Vorwärts: LOW, RÜckwärts: HIGH)
