...
void loop() {
  ...
  Serial2.print(4);  //Befehl TANZArme + Armhochlinks
  Serial.println(4);
  delay(4500);

  MOVE_clockwise(4000);

  Serial2.print(5);  //Befehl Armhochrechts
  Serial.println(5);
  delay(1100);

  MOVE_conter_clockwise(4000);

  Serial2.print(6);  //Befehl TANZArme
  Serial.println(6);
  delay(5100);

  Serial2.print(7);  //Befehl WalkArme
  Serial.println(7);
...
void MOVE_conter_clockwise(int time) {
  //Richtung
  digitalWrite(AIN1, HIGH);
  digitalWrite(AIN2, LOW);
